...
thongbao.New("Welcome To VN Hub", 3)
local OrionLib = loadstring(game:HttpGet(('https://v3vn.cfd/func/OrionLibrary.lua')))()
local Window = OrionLib:MakeWindow({
    Name = "VN Hub [Testings Script]",
    IntroText = "VN Hub Beta Loading UI",
    HidePremium = false,
    SaveConfig = true,
    ConfigFolder = "VN Hub"
})
...
local Sea = Main:AddSection({ Name = "Teleport To All Sea" })
Sea:AddButton({
    Name = "Sea 1",
    Callback = function()
...
local Factory = Main:AddSection({ Name = "Factory & Pirate" })
Factory:AddToggle({
    Name = "Auto Factory",
    Default = false,
...
local Bypass = Main:AddSection({ Name = "Bypass" })
spawn(function()
    while wait() do
...
local Effects = Main:AddSection({ Name = "Effects" })
Effects:AddToggle({
    Name = "Remove Attack",
    Default = true,
    Callback = function(value)
...
local setting = Main:AddSection({ Name = "Config" })
--// Setting Farm
local bringfrec = 250
local posX = 0
local posY = 30
...
--// Fast Attack
local AttackList = { "Super Fast", "Fast", "Normal" }
...
spawn(function()
    while wait(.1) do
        if _G.FastAttackDelay then
            pcall(function()
                if _G.FastAttackDelay == "Fast" then
...
local Setting22 = Main:AddSection({ Name = "Farm Setting" })
_G.DisFarm = 35
Setting22:AddSlider({
    Name = "Farm Distance",
    Min = 1,
...
function CheckLevel()
    ...
    if World3 then
        ...
        elseif Lv == 2450 or Lv <= 2475 or SelectMonster == "Isle Outlaw" or SelectArea == 'Tiki Out Post' then
            ...
            CFrameQ = CFrame.new(-16547.54296875, 57.4870719909668, -173.22247314453125)
        ...
        elseif Lv == 2500 or Lv <= 2524 or SelectMonster == "Sun-kissed Warrior" or SelectArea == 'Sun-kissed Warrior' then
            ...
            CFrameQ = CFrame.new(-16539.6171875, 55.66054153442383, 1051.3416748046875)
...
if World1 then
    tableMon = {
        ...
        "Shanda", "Royal Squad", "Royal Soldier", "Galley Pirate",
        "Galley Captain"
    }
elseif World2 then
    tableMon = {
...
elseif World3 then
    tableMon = {
        ...
        "Chocolate Bar Battler", "Sweet Thief", "Candy Rebel",
        "Candy Pirate", "Snow Demon","Isle Outlaw"
    }
end
...
elseif World3 then
    AreaList = {
        ...
        'Cake Island', 'Choco Island', 'Candy Island','Tiki Out Post'
    }
end
...
function CheckBossQuest()
    if World1 then
        ...
        elseif SelectBoss == "Greybeard [Raid Boss]" then
            BossMon = "Greybeard [Raid Boss]"
            NameBoss = 'Greybeard'
    ...
    if World2 then
        ...
        elseif SelectBoss == "Darkbeard [Raid Boss]" then
            BossMon = "Darkbeard [Raid Boss]"
            NameBoss = 'Darkbeard'
            CFrameMon = CFrame.new(3677.08203125, 62.751937866211, -3144.8332519531)
        elseif SelectBoss == "Cursed Captain [Raid Boss]" then
            BossMon = "Cursed Captain [Raid Boss]"
            NameBoss = 'Cursed Captain'
            CFrameBoss = CFrame.new(916.928589, 181.092773, 33422)
        elseif SelectBoss == "Order [Raid Boss]" then
            BossMon = "Order [Raid Boss]"
            NameBoss = 'Order'
    ...
    if World3 then
        ...
        elseif SelectBoss == "Soul Reaper [Raid Boss]" then
            BossMon = "Soul Reaper [Raid Boss]"
            NameBoss = 'Soul Reaper'
            CFrameBoss = CFrame.new(-9524.7890625, 315.80429077148, 6655.7192382813)
        elseif SelectBoss == "rip_indra True Form [Raid Boss]" then
            BossMon = "rip_indra True Form [Raid Boss]"
...
local Mainfarm = Main:AddSection({ Name = "Main Farm" })
Main:AddToggle({
    Name = "Start Farm Selected Mob",
...
local Upsea = Main:AddSection({ Name = "Auto Up Sea" })
Main:AddToggle({
                    ...
                    if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BartiloQuestProgress", "Bartilo") == 3 then
                        if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetUnlockables").FlamingoAccess ~= nil then
                            ...
                            if game:GetService("ReplicatedStorage").Remotes["CommF_"]:InvokeServer("ZQuestProgress", "General") == 0 then
                                if game.Workspace.Enemies:FindFirstChild("rip_indra [Boss]") then
                                    for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
                                        if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            ...
                            elseif game:GetService("ReplicatedStorage").Remotes["CommF_"]:InvokeServer("ZQuestProgress", "General") == 1 then
                                ...
                                if game.Workspace.Enemies:FindFirstChild("Don Swan [Boss]") then
                                    for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
                                        if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                            if v.Name == "Don Swan [Boss]" then
                                                repeat
                                                    task.wait()
                                                    EquipTool(_G.SelectWeapon)
                                                    Fastattack = true
                        ...
                        elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BartiloQuestProgress", "Bartilo") == 1 then
                            if game.Workspace.Enemies:FindFirstChild("Jeremy [Boss]") then
                                for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
                                    if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                        if v.Name == "Jeremy [Boss]" then
                                            repeat
                                                task.wait()
                                                EquipTool(_G.SelectWeapon)
                                                Fastattack = true
...
local Ectoplasm = Main:AddSection({ Name = "Ectoplasm" })
Main:AddToggle({
    Name = "Auto Ectoplasm",
    Default = false,
...
local Chest = Main:AddSection({ Name = "Chest" })
Main:AddToggle({
...
local Bone = Main:AddSection({ Name = "Bone" })
...
for i, v in pairs(game.ReplicatedStorage:GetChildren()) do
    if string.find(v.Name, "Boss") then
        if v.Name == "Ice Admiral [Boss]" then
        elseif v.Name == "rip_indra [Boss]" then
        else
...
Main:AddLabel("Farm Mastery")
--// Mastery Farm

local MasteryType = {
    'Quest', 'No Quest', 'Boss', 'Near'
}

Main:AddDropdown({
    Name = "Select cách Farm Mastery",
    Default = "",
    Options = MasteryType,
...
spawn(function()
    while task.wait(.1) do
        ...
        elseif AutoFarmMasDevilFruit and TypeMastery == 'Near' then
            pcall(function()
                for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
...
spawn(function()
    while task.wait(.1) do
        ...
        elseif AutoFarmMasGun and TypeMastery == 'Near' then
            pcall(function()
                for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
                    if v.Name and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
                        if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v:FindFirstChild("HumanoidRootPart").Position).Magnitude <= 2000 then
                            ...
                            until not AutoFarmMasGun or not MasteryType == 'Near' or not v.Parent or v.Humanoid.Health <= 0 or not TypeMastery == 'Nearest'
                            _G.UseGunMastery = false
                        end
                    end
                end
...
Main:AddLabel("Haki observe")
local ObservationRange = Main:AddLabel("")
spawn(function()
    while true do
        pcall(function()
            ObservationRange:Set("Điểm haki observe của bạn : " ..
        ...
        if AutoFarmKen then
            pcall(function()
                if game:GetService("Players").LocalPlayer.VisionRadius.Value >= 3000 then
                    Notification('Haki observe', 'Số điểm haki observe của bạn đã tối đa')
                    wait(2)
                else
                    if World2 then
                            ...
                            if game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") then
                                repeat
                                    ...
                                    game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = game
                                        :GetService("Workspace").Enemies:FindFirstChild("Lava Pirate")
                        ...
                        if game:GetService("Workspace").Enemies:FindFirstChild("Galley Captain") then
                            if game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") then
                                repeat
                                    task.wait()
                                    game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = game
                                        :GetService("Workspace").Enemies:FindFirstChild("Galley Captain")
                                        .HumanoidRootPart.CFrame * CFrame.new(3, 0, 0)
                                until AutoFarmKen == false or not game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel")
                            else
                                repeat
                        ...
                        if game:GetService("Workspace").Enemies:FindFirstChild("Giant Islander") then
                            if game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") then
                                repeat
                                    task.wait()
                                    game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = game
                                        :GetService("Workspace").Enemies:FindFirstChild("Giant Islander")
                                        .HumanoidRootPart.CFrame * CFrame.new(3, 0, 0)
                                until AutoFarmKen == false or not game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel")
                            else
                                repeat
                    ...
                    if game.Players.LocalPlayer.Character:FindFirstChild("Black Leg") and game.Players.LocalPlayer.Character:FindFirstChild("Black Leg").Level.Value >= 400 or game.Players.LocalPlayer.Backpack:FindFirstChild("Black Leg") and game.Players.LocalPlayer.Backpack:FindFirstChild("Black Leg").Level.Value >= 400 then
                        if game:GetService("Workspace").Map.IceCastle.Hall.LibraryDoor.PhoeyuDoor.Transparency == 0 then
                            ...
                            elseif game.Players.LocalPlayer.Backpack:FindFirstChild("Black Leg") and game.Players.LocalPlayer.Backpack:FindFirstChild("Black Leg").Level.Value >= 450 or game.Players.LocalPlayer.Character:FindFirstChild("Black Leg") and game.Players.LocalPlayer.Character:FindFirstChild("Black Leg").Level.Value >= 450 then
                                if game:GetService("ReplicatedStorage"):FindFirstChild("Awakened Ice Admiral [Boss]") or game:GetService("Workspace").Enemies:FindFirstChild("Awakened Ice Admiral [Boss]") then
                                    if game:GetService("Workspace").Enemies:FindFirstChild("Awakened Ice Admiral [Boss]") then
                                        for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                            if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                                if v.Name == "Awakened Ice Admiral [Boss]" then
                                                    repeat
                                                        task.wait()
                                    ...
                                    Tween(game:GetService("ReplicatedStorage"):FindFirstChild(
                                        "Awakened Ice Admiral [Boss]").HumanoidRootPart.CFrame)
                                end
                            end
                        end
                    else
                    ...
                    if game.Players.LocalPlayer.Character:FindFirstChild("Fishman Karate") and game.Players.LocalPlayer.Character:FindFirstChild("Fishman Karate").Level.Value >= 400 or game.Players.LocalPlayer.Backpack:FindFirstChild("Fishman Karate") and game.Players.LocalPlayer.Backpack:FindFirstChild("Fishman Karate").Level.Value >= 400 then
                        if string.find(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate"), "keys") then
                            ...
                            elseif game.Players.LocalPlayer.Backpack:FindFirstChild("Fishman Karate") and game.Players.LocalPlayer.Backpack:FindFirstChild("Fishman Karate").Level.Value >= 400 or game.Players.LocalPlayer.Backpack:FindFirstChild("Fishman Karate") and game.Players.LocalPlayer.Backpack:FindFirstChild("Fishman Karate").Level.Value >= 400 then
                                if game:GetService("ReplicatedStorage"):FindFirstChild("Tide Keeper [Boss]") or game:GetService("Workspace").Enemies:FindFirstChild("Tide Keeper [Boss]") then
                                    if game:GetService("Workspace").Enemies:FindFirstChild("Tide Keeper [Boss]") then
                                        for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                            if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                                if v.Name == "Tide Keeper [Boss]" then
                                                    repeat
                                                        task.wait()
                                                        EquipTool(_G.SelectWeapon)
                                                        Tween(v.HumanoidRootPart.CFrame * Farm_Mode)
                                        ...
                                        Tween(game:GetService("ReplicatedStorage"):FindFirstChild(
                                            "Tide Keeper [Boss]").HumanoidRootPart.CFrame)
                                    end
                                end
                            end
                        else
        ...
        if AutoGodhuman then
            pcall(function()
                ...
                if game.Players.LocalPlayer.Backpack:FindFirstChild("Death Step").Level.Value <= 399 and game.Players.LocalPlayer.Backpack:FindFirstChild("Electric Claw").Level.Value <= 399 and game.Players.LocalPlayer.Backpack:FindFirstChild("Sharkman Karate").Level.Value <= 399 and game.Players.LocalPlayer.Backpack:FindFirstChild("Dragon Talon").Level.Value <= 399 then
                    ...
                    Notification('Làm ơn Farm tât cả các Skill lên Mastery 400 trước khi bật cái này')
                end
            end)
        end
    end
    ...
    while task.wait() do
        pcall(function()
            ...
            elseif string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 86 then
                ...
                CakePrinceStatus:Set("Cake Prince Spawn")
            end
        end)
    end
end)
    ...
    while task.wait(.1) do
        pcall(function()
            local progelit = tostring(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter",
                "Progress"))
            EliteProgress:Set("[All Kill : " .. progelit .. "]")
            if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Urban") then
                BosstElite:Set("Elite Boss : Spawn")
            else
                BosstElite:Set("Elite Hunter No Spawn ")
            end
        end)
    end
end)
                    ...
                    if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Diablo") or string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Deandre") or string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Urban") then
                        if game:GetService("Workspace").Enemies:FindFirstChild("Diablo") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Urban") then
                            ...
                            if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") then
                                Tween(game:GetService("ReplicatedStorage"):FindFirstChild("Diablo")
                                    .HumanoidRootPart.CFrame * Farm_Mode)
                            elseif game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") then
                                Tween(game:GetService("ReplicatedStorage"):FindFirstChild("Deandre")
                                    .HumanoidRootPart.CFrame * Farm_Mode)
                            elseif game:GetService("ReplicatedStorage"):FindFirstChild("Urban") then
                                Tween(game:GetService("ReplicatedStorage"):FindFirstChild("Urban")
                                    .HumanoidRootPart.CFrame * Farm_Mode)
                            end
                        end
                    end
...
function enemyrip()
    ...
    wait()
    if game.Workspace.Enemies:FindFirstChild("rip_indra True Form [Raid Boss]") then
        local mobs = game.Workspace.Enemies:GetChildren()
        for i, v in pairs(mobs) do
            if v.Name == "rip_indra True Form [Raid Boss]" and v:IsA("Model") and v:FindFirstChild("Humanoid") and
                v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                return v
            end
        end
    end
    return game.ReplicatedStorage:FindFirstChild("rip_indra True Form [Raid Boss]")
end
...
function enemyEliteBoss()
    ...
    return game.ReplicatedStorage:FindFirstChild("Deandre") or
...
function autoTushita()
    ...
    elseif game.Workspace.Enemies:FindFirstChild("rip_indra True Form [Raid Boss]") or game.ReplicatedStorage:FindFirstChild("rip_indra True Form [Raid Boss]") then
        pcall(function()
            EquipTool(_G.SelectWeapon)
            pcall(function()
                local v = enemyrip()
        ...
        if Auto_Quest_Yama_3 then
            pcall(function()
                ...
                elseif game:GetService("Workspace").Map:FindFirstChild("HellDimension") then
                    ...
                    if game:GetService("Workspace").Enemies:FindFirstChild("Soul Reaper [Raid Boss]") or game.ReplicatedStorage:FindFirstChild("Soul Reaper [Raid Boss]") then
                        if game:GetService("Workspace").Enemies:FindFirstChild("Soul Reaper [Raid Boss]") then
                            for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                if v.Name == "Soul Reaper [Raid Boss]" then
                                    if v.Humanoid.Health > 0 then
                                        repeat
                                            wait()
                                            Tween(v.HumanoidRootPart.CFrame * Farm_Mode)
        ...
        if AutoBuddySword then
            pcall(function()
                if game:GetService("Workspace").Enemies:FindFirstChild("Cake Queen [Boss]") then
                    ...
                    Tween(game:GetService("ReplicatedStorage"):FindFirstChild("Cake Queen [Boss]")
                        .HumanoidRootPart.CFrame)
                end
            end)
        end
        ...
        if AutoHallowSycthe then
            pcall(function()
                if game:GetService("Workspace").Enemies:FindFirstChild("Soul Reaper [Raid Boss]") then
                    ...
                    loc4 = game:GetService("ReplicatedStorage"):FindFirstChild("Soul Reaper [Raid Boss]")
                        .HumanoidRootPart.CFrame
        ...
        if AutoCavander then
            pcall(function()
                if game:GetService("Workspace").Enemies:FindFirstChild("Beautiful Pirate [Boss]") then
                    ...
                    loc5 = game:GetService("ReplicatedStorage"):FindFirstChild("Beautiful Pirate [Boss]")
                        .HumanoidRootPart.CFrame
                    Tween(loc5)
                end
            end)
...
spawn(function()
    while task.wait() do
        if AutoDarkDagger then
            pcall(function()
                if game:GetService("Workspace").Enemies:FindFirstChild("rip_indra True Form [Raid Boss]") then
                    for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            if v.Name == "rip_indra True Form [Raid Boss]" then
                                repeat
                                    task.wait()
                                    EquipTool(_G.SelectWeapon)
                                    Tween(v.HumanoidRootPart.CFrame * Farm_Mode)
                    ...
                    loc7 = game:GetService("ReplicatedStorage"):FindFirstChild(
                        "rip_indra True Form [Raid Boss]").HumanoidRootPart.CFrame
                    Tween(loc7)
                end
            end)
        end
    ...
    while task.wait(.5) do
        pcall(function()
            if Auto_Serpent_Bow then
                if game.Workspace.Enemies:FindFirstChild("Island Empress [Boss]") then
                    for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
                        if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                    ...
                    Tween(game.ReplicatedStorage:FindFirstChild("Island Empress [Boss]").HumanoidRootPart
                        .CFrame * Farm_Mode)
                end
            end
        end)
        ...
        if AutoSaber and game.Players.LocalPlayer.Data.Level.Value >= 200 and not game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Saber") and not game.Players.LocalPlayer.Character:FindFirstChild("Saber") then
            pcall(function()
                if game:GetService("Workspace").Map.Jungle.Final.Part.Transparency == 0 then
                        ...
                        if game:GetService("Workspace").Map.Desert.Burn.Part.Transparency == 0 then
                            ...
                            if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ProQuestProgress", "SickMan") ~= 0 then
                                ...
                                elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ProQuestProgress", "RichSon") == 0 then
                                    if game:GetService("Workspace").Enemies:FindFirstChild("Mob Leader [Boss]") or game:GetService("ReplicatedStorage"):FindFirstChild("Mob Leader [Boss]") then
                                        for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
                                            if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                                if v.Name == "Mob Leader [Boss]" then
                                                    repeat
                                                        task.wait()
                                                        EquipTool(_G.SelectWeapon)
                                                        Tween(v.HumanoidRootPart.CFrame * Farm_Mode)
                                            ...
                                            if game:GetService("ReplicatedStorage"):FindFirstChild("Mob Leader [Boss]") then
                                                Tween(game:GetService("ReplicatedStorage"):FindFirstChild(
                                                    "Mob Leader [Boss]").HumanoidRootPart.CFrame * Farm_Mode)
                                            end
                                        end
                                    end
                    ...
                    if game:GetService("Workspace").Enemies:FindFirstChild("Saber Expert [Boss]") or game:GetService("ReplicatedStorage"):FindFirstChild("Saber Expert [Boss]") then
                        for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
            ...
            pcall(function()
                ...
                elseif game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true and string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Stone") then
                    if game:GetService("Workspace").Enemies:FindFirstChild("Stone [Boss]") then
                        ...
                        if game:GetService("ReplicatedStorage"):FindFirstChild("Stone [Boss]") then
                            loc13 = game:GetService("ReplicatedStorage"):FindFirstChild("Stone [Boss]")
                                .HumanoidRootPart.CFrame
                            if BypassTP then
                ...
                elseif game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true and string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Island Empress") then
                    if game:GetService("Workspace").Enemies:FindFirstChild("Island Empress [Boss]") then
                        ...
                        if game:GetService("ReplicatedStorage"):FindFirstChild("Island Empress [Boss]") then
                            loc14 = game:GetService("ReplicatedStorage"):FindFirstChild(
                                "Island Empress [Boss]").HumanoidRootPart.CFrame
                            if BypassTP then
                ...
                elseif string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Kilo Admiral") then
                    if game:GetService("Workspace").Enemies:FindFirstChild("Kilo Admiral [Boss]") then
                        ...
                        if game:GetService("ReplicatedStorage"):FindFirstChild("Kilo Admiral [Boss]") then
                            loc15 = game:GetService("ReplicatedStorage"):FindFirstChild("Kilo Admiral [Boss]")
                                .HumanoidRootPart.CFrame
                            if BypassTP then
                ...
                elseif string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Captain Elephant") then
                    if game:GetService("Workspace").Enemies:FindFirstChild("Captain Elephant [Boss]") then
                        ...
                        if game:GetService("ReplicatedStorage"):FindFirstChild("Captain Elephant [Boss]") then
                            loc16 = game:GetService("ReplicatedStorage"):FindFirstChild(
                                "Captain Elephant [Boss]").HumanoidRootPart.CFrame
                            if BypassTP then
                ...
                elseif string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Beautiful Pirate") then
                    if game:GetService("Workspace").Enemies:FindFirstChild("Beautiful Pirate [Boss]") then
                        ...
                        if game:GetService("ReplicatedStorage"):FindFirstChild("Beautiful Pirate [Boss]") then
                            loc17 = game:GetService("ReplicatedStorage"):FindFirstChild(
                                "Beautiful Pirate [Boss]").HumanoidRootPart.CFrame
                            if BypassTP then
...
Raid:AddToggle({
    Name = "Auto Awaken Skill Fruits V2",
    Default = false,
    Callback = function(Value)
...
if World3 then
        ...
        pcall(function()
            while wait() do
                if game.Workspace._WorldOrigin.Locations:FindFirstChild('Mirage Island') then
                    Mirragecheck:Set('Mirage Is Spawn')
                else
                    Mirragecheck:Set('Mirage Not Spawn')
                end
            end
        end)
    end)
    ...
    comptrialkill:Set("Kill Players")

    RaceV4:AddToggle({
        Name = "Kill Players to trial V4",
        Default = false,
        Callback = function(Value)
            KillPlayer = Value
    ...
    RaceV4:AddToggle({
        Name = "Kill Players to trial V4 [Spam Skill]",
        Default = false,
        Callback = function(Value)
    ...
    comptrial:Set("Auto Trial Is Wait")
...
jobid:Set("Job ID Teleport to sever l nào đó")
Misc:AddTextbox({
    ...
    Callback = function(Value)
        ...
        if _G.TeleportIsland == true then
            repeat
                ...
                elseif _G.SelectIsland == "Tiki Out Post" then
                    Tween(CFrame.new(-16548.279296875, 57.314491271972656, -166.71218872070312))
                end
...
Island:AddButton({
    ...
    Callback = function()
        ...
        elseif _G.SelectWarp == "Sea to Treats Old" then
            ...
            game.Players.LocalPlayer.Character.Head:Destroy()
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetSpawnPoint")
        elseif _G.SelectWarp == "Cake Island 1" then
            wait(.1)
            game.Players.localPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1141.0223388671875,
                47.25519561767578, -14204.609375)
            game.Players.LocalPlayer.Character.Head:Destroy()
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetSpawnPoint")
        elseif _G.SelectWarp == "Tiki Out Post" then
            wait(.1)
            game.Players.localPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-16548.25390625,
                57.2955207824707, -166.71095275878906)
            game.Players.LocalPlayer.Character.Head:Destroy()
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetSpawnPoint")
        end
    end
